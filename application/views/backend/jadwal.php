...
<html lang="en">
  <head>
    ...
    <title>Quản lý chuyến xe</title></title>
    <!-- css -->
  ...
  <body id="page-top">
    ...
    <div class="container-fluid">
      <h1 class="h5 text-gray-800">Quản lý chuyến xe</h1>
      <!-- DataTales Example -->
            ...
            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>$<?= number_format((float)($row['harga_jadwal']),0,",","."); ?></td>
                  <td><a href="<?= base_url('backend/jadwal/viewjadwal/'.$row['kd_jadwal']) ?>" class="btn btn-info">Xem</a></td>
                </td>
              </tr>
              <?php } ?>
            </tbody>
