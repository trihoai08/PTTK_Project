						...
						<tbody>
							...
							<tr>
								...
								<td align="center"><a href="<?= base_url('backend/bank/viewbank/'.$row['kd_bank']) ?>"
										class="btn btn btn-info">Xem Chi Tiết</a></a>
								</td>
							</tr>
							<?php } ?>
						</tbody>
				...
				<div class="modal-body">
					<form action="<?= base_url()?>backend/bank/tambahbank" method="post" enctype="multipart/form-data">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="nasabah" required placeholder="Tên chủ tài khoản">
						</div>
						<div class="form-group">
							<label class="">Tên Ngân Hàng</label>
							<input type="text" class="form-control" name="bank" required placeholder="Tên ngân hàng">
						</div>
						<div class="form-group">
							<label class="">Số Tài Khoản</label>
							<input type="number" class="form-control" name="nomor" required placeholder="Số tài khoản">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Tải Lên Logo Ngân Hàng</label>
